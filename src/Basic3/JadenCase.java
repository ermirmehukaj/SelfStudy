...
public class JadenCase {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(jaden("How can mirrors be real if our eyes aren't real"));
    }



    public static String jaden(String str){
        return Arrays.stream(str.split(" ")).map(s ->s.substring(0,1) .toUpperCase( ) + s.substring(1,s.length())).collect(Collectors.joining(" "));
    }
